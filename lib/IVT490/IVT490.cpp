...
namespace IVT490
{
    ...
    int parse_IVT490(String raw, IVT490State &parsed)
    {
        ...
        parsed.circulation_pump = (bool)split[16].toInt();
        parsed.fan = (bool)split[17].toInt();
        parsed.alarm = (bool)split[18].toInt();
        parsed.GT1_lower_limit = 0.1 * split[21].toFloat();
        parsed.GT1_target = 0.1 * split[22].toFloat();
        parsed.GT1_upper_limit = 0.1 * split[23].toFloat();
        parsed.GT3_2_lower_limit = 0.1 * split[24].toFloat();
        parsed.GT3_2_upper_limit = 0.1 * split[25].toFloat();
        parsed.GT3_3_upper_limit = 0.1 * split[26].toFloat();
        parsed.GT3_3_lower_limit = 0.1 * split[27].toFloat();
    ...
    DynamicJsonDocument serialize_IVT490State(const IVT490State &state)
    {
        ...
        doc["GT1_lower_limit"] = state.GT1_lower_limit;
        doc["GT1_upper_limit"] = state.GT1_upper_limit;
        doc["GT2_heatpump"] = state.GT2_heatpump;
        doc["GT2_sensor"] = state.GT2_sensor;
        doc["GT3_1"] = state.GT3_1;
        doc["GT3_2"] = state.GT3_2;
        doc["GT3_2_lower_limit"] = state.GT3_2_lower_limit;
        doc["GT3_2_upper_limit"] = state.GT3_2_upper_limit;
        doc["GT3_3"] = state.GT3_3;
        doc["GT3_3_target"] = state.GT3_3_target;
        doc["GT3_3_lower_limit"] = state.GT3_3_lower_limit;
        doc["GT3_3_upper_limit"] = state.GT3_3_upper_limit;
        ...
        doc["circulation_pump"] = state.circulation_pump;
